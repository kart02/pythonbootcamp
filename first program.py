...
for no in range(1,11):
    if no %2==0:
        print(no)
    tuple={"kartikey""Mayank""chetan"}
    print(type(set))
    sets = {"kartikey""Mayank""chetan"}
    sets.add("Mayank")
    sets.remove("Mayank")
    #sets[0] = "gfhgfh"
    print(sets)
